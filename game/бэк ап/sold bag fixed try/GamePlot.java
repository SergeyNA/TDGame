...
public class GamePlot {
	 ...
	 * конструктор от стринга у эвента (изи)
	...
	/*
	 * лафа длилась недолго. продажа башни не пашет. кривое удаление. низя строить там где была совершена продажа
	 * возможно надо обновить массивы состояний
	 * и всё заработает
	 * ещё можно застрелиться
	 * или покушать...
	 * 
	*/
