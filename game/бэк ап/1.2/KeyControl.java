		...
		if (code == 10) {
			if(enterWaiting) {
				if(updateChoice == 0) {
					...
					if(towerControl.priceChanges(towerUpdate[0], towerUpdate[1], towerUpdate[2], 0, true) <= score) {
						score -= towerControl.priceChanges(towerUpdate[0], towerUpdate[1], towerUpdate[2], 0, true);
