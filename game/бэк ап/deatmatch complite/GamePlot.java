...
public class GamePlot {
	...
	GamePlot(int state) {
		...
		case -1:
			...
			towerTypeCharacteristics = new int[towerVariant][10];
			//damage dist cooldown ammoCount maxDamage maxDist maxRate stepDamage stepDist stepRate
			towerTypeCharacteristics[0] = new int[]{25, 200, 250, 1, 400, 400, 50, 25, 25, 2};
			towerTypeCharacteristics[1] = new int[]{1, 120, 20, 10000, 25, 200, 20, 1, 1, 0};
			towerTypeCharacteristics[2] = new int[]{10, 150, 150, 3, 150, 400, 16, 5, 5, 2};
			towerTypeCharacteristics[3] = new int[]{1, 100, 15, 1, 25, 250, 1, 1, 5, 1};
			//
	...
	/*
	 * синхронизировать итерацию по коллекции башен с её изменением в кейконтроле
	*/
